...
public:
	...
	{
		Matrix matrix(4, 4);
		matrix.value[0][0] = pointAt.value[0][0]; matrix.value[0][1] = pointAt.value[1][0]; matrix.value[0][2] = pointAt.value[2][0]; matrix.value[0][3] = 0.0f;
		matrix.value[1][0] = pointAt.value[0][1]; matrix.value[1][1] = pointAt.value[1][1]; matrix.value[1][2] = pointAt.value[2][1]; matrix.value[1][3] = 0.0f;
		matrix.value[2][0] = pointAt.value[0][2]; matrix.value[2][1] = pointAt.value[1][2]; matrix.value[2][2] = pointAt.value[2][2]; matrix.value[2][3] = 0.0f;
		matrix.value[3][0] = -(pointAt.value[3][0] * matrix.value[0][0] + pointAt.value[3][1] * matrix.value[1][0] + pointAt.value[3][2] * matrix.value[2][0]);
		matrix.value[3][1] = -(pointAt.value[3][0] * matrix.value[0][1] + pointAt.value[3][1] * matrix.value[1][1] + pointAt.value[3][2] * matrix.value[2][1]);
		matrix.value[3][2] = -(pointAt.value[3][0] * matrix.value[0][2] + pointAt.value[3][1] * matrix.value[1][2] + pointAt.value[3][2] * matrix.value[2][2]);
